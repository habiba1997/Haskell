...
/* package frp-0.1.0.0 */
#ifndef VERSION_frp
#define VERSION_frp "0.1.0.0"
#endif /* VERSION_frp */
#ifndef MIN_VERSION_frp
#define MIN_VERSION_frp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_frp */
...
#define CURRENT_COMPONENT_ID "frp-0.1.0.0-inplace-Addition"
